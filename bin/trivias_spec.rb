require_relative '../lib/trivias'

describe Phrases do
  let(:trivias) { Trivias.new }

  context 'initialize' do
    it 'It checks if the array is equal' do
      expect(trivias.trivia).to eq([
                                     'Romantic poet Percy Bysshe Shelley drowned, aged 29, in 1822, off the coast of WHERE?
            A. Portugal
            B. Italy
            C. Spain
            D. France',
